...
Form::FormIsNotSigned::FormIsNotSigned(const Form::FormIsNotSigned &rhs) throw() {
    *this = rhs;
}

Form::FormIsNotSigned& Form::FormIsNotSigned::operator=(const Form::FormIsNotSigned &rhs) throw() {
    rhs.what();
    return *this;
}
...
const char* Form::FormIsNotSigned::what() const throw() {
    return "Attempting to execute not signed form!";
}
